...
},
{
    ...
    imageUri: "https://i.pinimg.com/736x/1d/ad/8c/1dad8c62740644b5c4681bb12d81d184.jpg"
},
{
  ...
  return (
    ...
    >
      {projects.map((project) => (
        <SwiperSlide><Card title={project.title} description={project.description} imageUri={project.imageUri} githubLink={project.githubLink} projectLink={project.projectLink}/></SwiperSlide>
      ))}
      ...
    </Swiper>
  );
