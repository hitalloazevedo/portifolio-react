      ...
      <div className="content-about">
        ...
        <div className="about-content">
          ...
          <p>
            ...
            python, I fell in love, since then I have been studying and
            improving my skills every day, to be honest in my opinion to achieve
            success in this career it's too important be curious and have hungry
            about knowledge.
          </p>
        </div>
      </div>
